  ...
  return <>
    ...
    <main>
      ...
      <section className="ServicesContainer">
        <h2 className="Title" id="Nos_services">Nos services</h2>
      ...
      <section className="EventsContainer">
        <h2 className="Title" id="Nos_realisations">Nos réalisations</h2>
        <EventList />
      </section>
      <section className="PeoplesContainer">
        <h2 className="Title" id="Notre_equipe">Notre équipe</h2>
